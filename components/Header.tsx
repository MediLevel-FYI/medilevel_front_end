        ...
        <div className="flex items-center justify-between">
          ...
          >
            <Image 
              ...
              width={40}
              height={40}
              alt="A blue cross with a superimposed trend line going up and to the right, representing the increasing compensation that is expected with increased experience in the medical profession."
            />
            MedPay
          </Link>
